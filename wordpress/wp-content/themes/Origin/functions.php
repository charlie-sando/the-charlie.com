...
if ( ! function_exists( 'et_setup_theme' ) ){
	function et_setup_theme(){
		...
		require_once( $template_directory . '/includes/post_thumbnails_origin.php' );
...
if ( function_exists( 'get_custom_header' ) ) {
	...
	function et_origin_customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'et_origin[sidebar_text_color]', array(
			'default'		    => '#ffffff',
			'type'			    => 'option',
			'capability'	    => 'edit_theme_options',
			'transport'		    => 'postMessage',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'et_origin[sidebar_text_color]', array(
			'label'		=> __( 'Sidebar Text Color', 'Origin' ),
			'section'	=> 'colors',
			'settings'	=> 'et_origin[sidebar_text_color]',
		) ) );

		$wp_customize->add_setting( 'et_origin[sidebar_links_color]', array(
			'default'		    => '#ffffff',
			'type'			    => 'option',
			'capability'	    => 'edit_theme_options',
			'transport'		    => 'postMessage',
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'et_origin[sidebar_links_color]', array(
			'label'		=> __( 'Sidebar Links Color', 'Origin' ),
			'section'	=> 'colors',
			'settings'	=> 'et_origin[sidebar_links_color]',
		) ) );
	...
	function et_origin_add_customizer_css(){ ?>
		<style>
			...
			#sidebar, #sidebar h4 { color: <?php echo esc_html( et_get_option( 'sidebar_text_color', '#ffffff' ) ); ?>; }

			#sidebar a, #top-menu li a { color: <?php echo esc_html( et_get_option( 'sidebar_links_color', '#ffffff' ) ); ?>; }
